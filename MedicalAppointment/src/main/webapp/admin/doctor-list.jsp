...
<head>
        ...
        <title>Bệnh viện đa khoa Đan Phượng - Doctor List Page</title>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="#" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="<%=doc.getUser_avatar() %>" alt="User Image"></a>
															<a href="#"><%=doc.getUser_fullname() %></a>
														</h2>
													</td>
													<td><%=sp.getDoctorSp(doc.getUser_parent_id()) %></td>
													
													<td><%=doc.getUser_created_date() %></td>		
												</tr>
												<%
												}
												%>												
