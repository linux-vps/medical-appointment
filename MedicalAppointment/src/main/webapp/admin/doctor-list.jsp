...
<span>Sign Out</span>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="doctor-list.jsp">
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="#" class="avatar avatar-sm mr-2"><img style="width:10%;" class="avatar-img rounded-circle" src="<%=doc.getUser_avatar() %>" alt="User Image"></a>
