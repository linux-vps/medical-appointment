...
<head>
        ...
        <title>Bệnh viện đa khoa Đan Phượng - Patient List Page</title>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="#" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="<%=p.getUser_avatar() %>" alt="User Image"></a>
